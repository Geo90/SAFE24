...
\include{1_introduction/introdutcion}	% background information
...
\include{8_materials_and_methods/materials_methods}               % description of lab methods results
\include{6_results/results}
\include{7_discussion/discussion}      			    % discussion of
