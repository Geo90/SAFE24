...
% ----------------------------------------------------------------------
Många hållplatser i Malmö och andra städer är utsatta för vandalisering. Det handlar mest om hållplatser som är utanför stadens centrum eller utanför övervakningsområden. Skadegörelse kostar pengar eftersom vandaliseringen kräver reparationer. Gruppen (SAFE24) ska med hjälp av Axis IP-kamera lösa problemet med vandalisering och även otrygghet omkring busshållsplatserna med ett smart övervakningssystem.
\begin{figure}[h]
